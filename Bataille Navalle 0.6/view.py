...
coulerv=[PhotoImage(file = "couler1v.png"),PhotoImage(file = "couler2v.png"),PhotoImage(file = "couler3v.png"),
      PhotoImage(file = "couler3v.png"),PhotoImage(file = "couler5v.png"),PhotoImage(file = "r.png")]
coulerh=[PhotoImage(file = "couler1h.png"),PhotoImage(file = "couler2h.png"),PhotoImage(file = "couler3h.png"),
      PhotoImage(file = "couler3h.png"),PhotoImage(file = "couler5h.png"),PhotoImage(file = "r.png")]
...
def createboat():
    ...
    boat2 = cnv1.create_image(xboat+60*1,yboat,image=vert[1])
    boat3 = cnv1.create_image(xboat+60*2,yboat,image=vert[2])
    boat4 = cnv1.create_image(xboat+60*3,yboat,image=vert[3])
    boat5 = cnv1.create_image(xboat+60*4,yboat,image=vert[4])
    global Coop1
    Coop1 = [[xboat,yboat,"verticale"],[xboat+60,yboat,"verticale"],[xboat+60*2,yboat,"verticale"],[xboat+60*3,yboat,"verticale"],]
...
def clic(event):
    ...
    global long
    global boat
    if (Coop1[0][2]=="verticale" and Coop1[0][0]-25<event.x<Coop1[0][0]+25 and Coop1[0][1]-25*5<event.y<Coop1[0][1]+25*5) or (Coop1[0][2]=="horizontale" and Coop1[0][0]-25*5<event.x<Coop1[0][0]+25*5 and Coop1[0][1]-25<event.y<Coop1[0][1]+25):
        long = 5
        boat = boat1
